    ...
    <div className="bg-white overflow-hidden">
      <div className="w-full max-w-4xl mx-auto text-center py-20 px-6 sm:py-24 sm:px-8">
        ...
        <div className="mt-10">
          <Link
            href="/demo"
            className="inline-flex items-center justify-center px-8 py-4 text-base font-bold rounded-md text-white bg-primary-600 hover:bg-primary-700 transition-all duration-200 transform hover:scale-105 shadow-lg"
          >
            Pruebalo Gratis
          </Link>
